...
cc_itsouth <- prepare_the_regional_data("it_south", 768, 968)
...
ggplot(data.frame(cc_itsouth$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  geom_quasirandom(alpha = 0.1) +
  annotate("segment",
           y =      cc_itsouth$slope_max,
           yend =   cc_itsouth$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     cc_itsouth$slope_min,
           yend =  cc_itsouth$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
