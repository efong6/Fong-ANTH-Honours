...
mm_desouth <- prepare_the_regional_data("de_south", 1000, 1200)
...
ggplot(data.frame(mm_desouth$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  geom_quasirandom(alpha = 0.1) +
  annotate("segment",
           y =      mm_desouth$slope_max,
           yend =   mm_desouth$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     mm_desouth$slope_min,
           yend =  mm_desouth$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
