...
mm_uknorth <- prepare_the_regional_data("uk_north", 800, 1000)
...
ggplot(data.frame(mm_uknorth$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  geom_quasirandom(alpha = 0.1) +
  annotate("segment",
           y =      mm_uknorth$slope_max,
           yend =   mm_uknorth$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     mm_uknorth$slope_min,
           yend =  mm_uknorth$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
...
ggsave("mm_uk-north_before_.pdf")