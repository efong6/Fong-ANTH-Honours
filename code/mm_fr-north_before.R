...
mm_frnorth <- prepare_the_regional_data("fr_north", 800, 1000)
...
ggplot(data.frame(mm_frnorth$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  geom_quasirandom(alpha = 0.1) +
  annotate("segment",
           y =      mm_frnorth$slope_max,
           yend =   mm_frnorth$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     mm_frnorth$slope_min,
           yend =  mm_frnorth$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
