...
cc_netherlands <- prepare_the_regional_data("nl", 768, 968)
...
ggplot(data.frame(cc_netherlands$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  geom_quasirandom(alpha = 0.1) +
  annotate("segment",
           y =      cc_netherlands$slope_max,
           yend =   cc_netherlands$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     cc_netherlands$slope_min,
           yend =  cc_netherlands$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
...
ggsave("cc_netherlands_after.pdf")
