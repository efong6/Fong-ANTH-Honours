...
mm_frsouth <- prepare_the_regional_data("fr_south", 1000, 1200)
...
ggplot(data.frame(mm_frsouth$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  geom_quasirandom(alpha = 0.1) +
  annotate("segment",
           y =      mm_frsouth$slope_max,
           yend =   mm_frsouth$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     mm_frsouth$slope_min,
           yend =  mm_frsouth$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
