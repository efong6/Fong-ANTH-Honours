...
bd_itnorth <- prepare_the_regional_data("it_north", 1140, 1340)
...
ggplot(data.frame(bd_itnorth$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  geom_quasirandom(alpha = 0.1) +
  annotate("segment",
           y =      bd_itnorth$slope_max,
           yend =   bd_itnorth$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     bd_itnorth$slope_min,
           yend =  bd_itnorth$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
