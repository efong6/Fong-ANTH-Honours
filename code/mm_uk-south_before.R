...
mm_uksouth <- prepare_the_regional_data("uk_south", 1140, 1340)
...
ggplot(data.frame(mm_uksouth$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  geom_quasirandom(alpha = 0.1) +
  annotate("segment",
           y =      mm_uksouth$slope_max,
           yend =   mm_uksouth$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     mm_uksouth$slope_min,
           yend =  mm_uksouth$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
