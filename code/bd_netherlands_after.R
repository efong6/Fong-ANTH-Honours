...
bd_nl <- prepare_the_regional_data("nl", 1340, 1540)
...
ggplot(data.frame(bd_nl$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  ...
  annotate("segment",
           y =      bd_nl$slope_max,
           yend =   bd_nl$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     bd_nl$slope_min,
           yend =  bd_nl$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
...
ggsave("bd_netherlands_before.pdf")