...
gc_itsouth <- prepare_the_regional_data("it_south", 940, 1140)
...
ggplot(data.frame(gc_itsouth$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  geom_quasirandom(alpha = 0.1) +
  annotate("segment",
           y =      gc_itsouth$slope_max,
           yend =   gc_itsouth$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     gc_itsouth$slope_min,
           yend =  gc_itsouth$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
