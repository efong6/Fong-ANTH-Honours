...
ggplot(data.frame(cc_belgium$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  geom_quasirandom(alpha = 0.1) +
  annotate("segment",
           y =      cc_belgium$slope_max,
           yend =   cc_belgium$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     cc_belgium$slope_min,
           yend =  cc_belgium$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
