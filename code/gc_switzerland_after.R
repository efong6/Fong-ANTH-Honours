...
gc_ch <- prepare_the_regional_data("ch", 1140, 1340)
...
ggplot(data.frame(gc_ch$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  ...
  annotate("segment",
           y =      gc_ch$slope_max,
           yend =   gc_ch$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     gc_ch$slope_min,
           yend =  gc_ch$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
...
ggsave("gc_switzerland_after.pdf")