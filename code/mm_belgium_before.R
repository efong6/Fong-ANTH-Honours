...
mm_belgium <- prepare_the_regional_data("be", 800, 1000)
...
ggplot(data.frame(mm_belgium$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  geom_quasirandom(alpha = 0.1) +
  annotate("segment",
           y =      mm_belgium$slope_max,
           yend =   mm_belgium$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     mm_belgium$slope_min,
           yend =  mm_belgium$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
