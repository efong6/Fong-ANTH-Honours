...
bd_ch <- prepare_the_regional_data("ch", 1140, 1340)
...
ggplot(data.frame(bd_ch$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  ...
  annotate("segment",
           y =      bd_ch$slope_max,
           yend =   bd_ch$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     bd_ch$slope_min,
           yend =  bd_ch$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
...
ggsave("bd_switzerland_before.pdf")
