...
gc_uknorth <- prepare_the_regional_data("uk_north", 1140, 1340)
...
ggplot(data.frame(gc_uknorth$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  geom_quasirandom(alpha = 0.1) +
  annotate("segment",
           y =      gc_uknorth$slope_max,
           yend =   gc_uknorth$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     gc_uknorth$slope_min,
           yend =  gc_uknorth$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
