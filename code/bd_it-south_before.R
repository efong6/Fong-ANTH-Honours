...
bd_itsouth <- prepare_the_regional_data("it_south", 1140, 1340)
...
ggplot(data.frame(bd_itsouth$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  geom_quasirandom(alpha = 0.1) +
  annotate("segment",
           y =      bd_itsouth$slope_max,
           yend =   bd_itsouth$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     bd_itsouth$slope_min,
           yend =  bd_itsouth$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
