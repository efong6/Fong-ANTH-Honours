...
gc_frnorth <- prepare_the_regional_data("fr_north", 1140, 1340)
...
ggplot(data.frame(gc_frnorth$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  geom_quasirandom(alpha = 0.1) +
  annotate("segment",
           y =      gc_frnorth$slope_max,
           yend =   gc_frnorth$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     gc_frnorth$slope_min,
           yend =  gc_frnorth$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
