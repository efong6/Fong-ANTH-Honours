...
gc_frsouth <- prepare_the_regional_data("fr_south", 1140, 1340)
...
ggplot(data.frame(gc_frsouth$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  geom_quasirandom(alpha = 0.1) +
  annotate("segment",
           y =      gc_frsouth$slope_max,
           yend =   gc_frsouth$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     gc_frsouth$slope_min,
           yend =  gc_frsouth$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
