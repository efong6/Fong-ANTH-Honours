...
gc_desouth <- prepare_the_regional_data("de_south", 1140, 1340)
...
ggplot(data.frame(gc_desouth$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  geom_quasirandom(alpha = 0.1) +
  annotate("segment",
           y =      gc_desouth$slope_max,
           yend =   gc_desouth$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     gc_desouth$slope_min,
           yend =  gc_desouth$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
