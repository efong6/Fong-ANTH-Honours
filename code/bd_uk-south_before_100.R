...
bd_uksouth <- prepare_the_regional_data("uk_south", 1140, 1240)
...
ggplot(data.frame(bd_uksouth$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  geom_quasirandom(alpha = 0.1) +
  annotate("segment",
           y =      bd_uksouth$slope_max,
           yend =   bd_uksouth$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     bd_uksouth$slope_min,
           yend =  bd_uksouth$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
...
ggsave("bd_uk-south_before_100.pdf")