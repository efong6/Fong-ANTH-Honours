...
bd_belgium <- prepare_the_regional_data("be", 1340, 1540)
...
ggplot(data.frame(bd_belgium$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  geom_quasirandom(alpha = 0.1) +
  annotate("segment",
           y =      bd_belgium$slope_max,
           yend =   bd_belgium$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     bd_belgium$slope_min,
           yend =  bd_belgium$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
