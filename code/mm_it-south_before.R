...
mm_itsouth <- prepare_the_regional_data("it_south", 800, 1000)
...
ggplot(data.frame(mm_itsouth$bootresultd[[2]])) +
  aes(0.25, 
      slope) +
  geom_boxplot() +
  geom_quasirandom(alpha = 0.1) +
  annotate("segment",
           y =      mm_itsouth$slope_max,
           yend =   mm_itsouth$slope_max,
           x = 0,
           xend = 0.5,
           colour = "red") +
  annotate("segment",
           y =     mm_itsouth$slope_min,
           yend =  mm_itsouth$slope_min,
           x =    0,
           xend = 0.5,
           colour = "red") +
  annotate("text",
